              ...
              {canSwitchToBuyer && viewMode === 'buyer' && (
                <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                  ...
                  <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-pickfirst-yellow/10 border border-pickfirst-yellow/30">
                    ...
                    <span className="text-base font-bold text-pickfirst-yellow">Buyer</span>
                  </div>
                  {/* Mobile: Compact badge with smaller text + icon-only button */}
                  <div className="sm:hidden flex items-center gap-1 px-1.5 py-1 rounded-lg bg-pickfirst-yellow/10 border border-pickfirst-yellow/30">
                    <span className="text-[10px] font-medium text-pickfirst-yellow">Buyer</span>
                  </div>
                  <Button
                    onClick={() => {
                      toggleViewMode();
                    ...
                    variant="outline"
                    size="sm"
                    className="relative overflow-hidden bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-300/50 text-amber-700 hover:from-amber-100 hover:to-yellow-100 hover:border-amber-400/70 hover:text-amber-800 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/20 group shrink-0 h-7 sm:h-9 px-2 sm:px-3"
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      <span className="hidden sm:inline font-medium text-sm ml-2">Switch to Agent Mode</span>
                    </div>
                  </Button>
                </div>
              )}
