            ...
            {buyerActions.map((action, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`p-3 rounded-xl ${action.color} transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg shadow-yellow-600/10`}
                  >
            ...
            <div className="flex items-center gap-3">
              {!sidebarOpen && (
                ...
                >
                  ...
                  />
                  <span className="hidden md:inline font-bold text-foreground text-lg tracking-tight">
                    PickFirst
                  </span>
                </div>
              )}
          ...
          <div className="relative overflow-visible rounded-3xl border border-gray-200 bg-white/60 shadow-2xl shadow-yellow-500/10 backdrop-blur-sm">
            ...
            <div className="relative z-[110] flex flex-col gap-4 px-6 py-8 lg:px-12 lg:py-12 items-center text-center">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="hidden md:block">
                  <span className="font-bold text-2xl tracking-tight bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent drop-shadow-lg">
                    PickFirst
                  </span>
                  <div className="text-xs text-foreground/80 font-semibold drop-shadow">
                    Premium Properties
                  </div>
                </div>
              </div>
              ...
              <p className="max-w-2xl text-sm text-muted-foreground">
                Use our smart filters to surface approved, premium, and off-market homes that
                match your needs. The search runs instantly and stays flexible like the market.
              </p>
