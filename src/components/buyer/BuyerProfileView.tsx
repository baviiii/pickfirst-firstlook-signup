...
import { Phone, Mail, MapPin, Building, Star, MessageSquare, Home, DollarSign, Calendar, TrendingUp, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-white">{buyer.full_name}</h2>
              ...
              {buyer.location && (
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span className="text-gray-300">{buyer.location}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">{buyer.email}</span>
              </div>
              {buyer.phone && (
                <div className="flex items-center gap-3">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white text-lg flex items-center gap-2">
                <Home className="h-5 w-5 text-pickfirst-yellow" />
                Property Preferences
              </CardTitle>
            </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-white">Budget Range</span>
                  </div>
                  <p className="text-gray-300">{getBudgetDisplay(buyer.budget_range)}</p>
                </div>
                
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="h-4 w-4 text-pickfirst-yellow" />
                    <span className="text-sm font-medium text-white">Preferred Areas</span>
                  </div>
              ...
              {buyer.property_type_preferences && buyer.property_type_preferences.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-white">Property Types</span>
                  </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-pickfirst-yellow">{buyer.total_inquiries}</div>
                  <div className="text-sm text-gray-400">Property Inquiries</div>
                </div>
                <div className="text-center p-3 bg-gray-700/50 rounded-lg">
                  <div className="text-2xl font-bold text-pickfirst-yellow">{buyer.favorite_properties_count}</div>
                  <div className="text-sm text-gray-400">Saved Properties</div>
                </div>
              </div>
