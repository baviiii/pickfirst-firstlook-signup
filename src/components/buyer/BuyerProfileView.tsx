        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-bold text-white mb-2">{buyer.full_name}</h2>
              ...
              {buyer.location && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-300">{buyer.location}</span>
                </div>
              )}
            </div>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-300 pl-6">{getBudgetDisplay(buyer.budget_range)}</p>
                </div>
              ...
              <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    <p className="text-blue-400 font-medium mb-1">Agent Tips:</p>
